...
// LunaTextDateFormFieldState _globalState = new LunaTextDateFormFieldState();

class LunaTextDateFormField extends StatefulWidget {
  LunaTextDateFormField(
      {Key key,
      this.label,
      this.initialDate,
      this.enabled = true,
  ...
  @override
  LunaTextDateFormFieldState createState() => new LunaTextDateFormFieldState();
  //_MyAppBarButtonState createState() => new _MyAppBarButtonState();

  //_LunaTextDateFormFieldState createState() => _LunaTextDateFormFieldState();
  // GlobalKey<_LunaTextDateFormFieldState> myWidgetStateKey = new GlobalKey<_LunaTextDateFormFieldState>();

}

class LunaTextDateFormFieldState extends State<LunaTextDateFormField> {
  String yyyysmmsdd;
  ...
  Widget build(BuildContext context) {
    return 
    InputDecorator(child: dateRow(), 
    decoration: InputDecoration(errorText: "Harap isi tgl yang benar", helperText: "Isi Tgl" ));
    // Row(children: <Widget>[
    //   Stack(

...
/// to the user.
class LunaDateFormField extends FormField<DateTime> {
    ...
    this.inputFormatters,
        ...
        super(
            ...
            builder: (FormFieldState<DateTime> field) {
              // final _LunaDateFormFieldState state = field;
            });

  @override
  _LunaDateFormFieldState createState() =>
      _LunaDateFormFieldState(this);
}

class _LunaDateFormFieldState extends FormFieldState<DateTime> {
  final LunaDateFormField parent;

...
class _SharedPrefScreenState extends State<SharedPrefScreen> {
  ...
  TextEditingController _controllerDomainServer =
      new TextEditingController(text: "mockserver");
...
//   }
        ...
        child: new Container(
          ...
          child: new Column(
            ...
            children: <Widget>[
              ...
              (_domainComboList.length>0) ? domainDropDown : Container(),
              new TextFormField(
  ...
  _savePrefs() async {
    ...
    await SharedPrefsHelperStatic.setString(
        PREFKEY_DOMAINSERVER, _controllerDomainServer.text);
    await SharedPrefsHelperStatic.setString(PREFKEY_DOMAINNAME, _domainName);
    await SharedPrefsHelperStatic.setString(
  ...
  _getPrefs() async {
    ...
    _controllerToken.text = SharedPrefsHelperStatic.getString(PREFKEY_TOKEN);
    _controllerDomainServer.text =
        SharedPrefsHelperStatic.getString(PREFKEY_DOMAINSERVER);
